...
entity beambender_top is
    port (
        ...
        clk_27m         : in    std_logic                 ; -- 27 MHz local oscillator. PCLKT7_1, PLL x5.5 -> 148.5 MHz
        clk_24m576      : in    std_logic                 ; -- 24.576 MHz local oscillator. PCLKT2_0, audio MCLK ref
        ...
        -- OSD buttons
        btn_1           : in    std_logic                 ; -- OSD button 1 (debounced RC, active low)
        btn_2           : in    std_logic                 ; -- OSD button 2 (debounced RC, active low)
        btn_3           : in    std_logic                 ; -- OSD button 3 (debounced RC, active low)
        ...
        -- Audio ADC (AK5720). I2S data path runs AK5720 -> SiI9022A
        -- directly; FPGA supplies MCLK and configuration only.
        ...
        adc_fsel        : out   std_logic                 ; -- AK5720 sample rate select
        adc_dif         : out   std_logic                  -- AK5720 audio data format select
    );
